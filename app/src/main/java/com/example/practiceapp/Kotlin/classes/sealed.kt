...
sealed class IOError(): com.example.practiceapp.Kotlin.classes.Error

class FileReadError(val file: File): com.example.practiceapp.Kotlin.classes.IOError()
class DatabaseError(val source: DataSource): com.example.practiceapp.Kotlin.classes.IOError()

object RuntimeError : com.example.practiceapp.Kotlin.classes.Error
