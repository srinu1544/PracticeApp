...
sealed class Shape {
    ...
    class Square(val side : Int) : com.example.practiceapp.Kotlin_Android.classes.Shape()

    object noShape : com.example.practiceapp.Kotlin_Android.classes.Shape()
...
fun checkShape(shape: com.example.practiceapp.Kotlin_Android.classes.Shape) {
