...
-> finally is the block in Java Exception Handling to execute the important code whether the exception
   occurs or not.
...
-> finalize is the method in Java which is used to perform clean up processing just before object
...
note : it is not part of kotlin it is the part of java we can call form kotlin
